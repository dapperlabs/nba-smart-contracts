...
func GenerateTopShotContract(ftAddr string, nftAddr string, metadataViewsAddr string, topShotLockingAddr string, royaltyAddr string) []byte {
	...
	return []byte(codeWithTopShotRoyaltyAddr)
}

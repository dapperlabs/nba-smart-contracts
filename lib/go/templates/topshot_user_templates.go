...
//go:generate go run github.com/kevinburke/go-bindata/go-bindata -prefix ../../../transactions/user -o internal/assets/assets.go -pkg assets -nometadata -nomemcopy ../../../transactions/user
